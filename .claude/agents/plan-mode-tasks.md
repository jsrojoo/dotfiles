...
description: Plan-mode worker for creating and maintaining plan.md and tasks.md artifacts for approved plans. Use after a plan has been approved and needs to be persisted as task artifacts.

...
description: Testing-focused worker for verification planning, test execution, and concise result reporting. Use for focused verification after implementation.

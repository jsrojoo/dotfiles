...
- Every planning conversation must use the `termaid` skill to create, render, and inspect at least one standard Mermaid diagram in `plan.md`; keep `tasks.md` diagram-free.

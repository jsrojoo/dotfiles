...
- Configure subagent through `agent-skills/agents/workflow-testing.toml` and `agent-skills/agents/workflow-testing.md`, with model selection kept in agent config.

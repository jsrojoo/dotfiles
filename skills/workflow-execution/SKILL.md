...
- Prefer temp script files as the default way to run commands, especially anything with quoting or multi-line content.
...
- If you use `tmux send-keys`, run the temp script via send-keys rather than inline command strings.
